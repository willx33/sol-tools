...
class BundleFinder(BaseDragonComponent):
    def __init__(self, *args, **kwargs): ...
    def run(self, *args, **kwargs) -> Dict[str, Any]: ...
    def teamTrades(self, address: str) -> List[str]: ...
    def checkBundle(self, tx_hash1: str, tx_hash2: str) -> Dict[str, Any]: ...
    def prettyPrint(self, data: Dict[str, Any], address: str) -> str: ...
